...
namespace Cdktf.Dotnet.Aws
{
    public class VpcModuleVariables
    {
        ...
        /// </summary>
        public bool IntraDedicatedNetworkAcl { get; set; } = false;

        /// <summary>
        /// Additional tags for the intra subnets network ACL
        /// </summary>
        public IDictionary<string, string> IntraAclTags { get; set; } = new Dictionary<string, string>();

        /// <summary>
        ///  Intra subnets inbound network ACLs
        /// </summary>
        public IList<NetworkAclIngress> IntraInboundAclRules { get; set; } = new List<NetworkAclIngress>
        {
            new NetworkAclIngress
            {
                RuleNo = 100,
        ...
        /// </summary>
        public IList<NetworkAclEgress> IntraOutboundAclRules { get; set; } = new List<NetworkAclEgress>
        {
            new NetworkAclEgress
            {
                RuleNo = 100,
        ...
        /// </summary>
        public bool RedshiftDedicatedNetworkAcl { get; set; } = false;

        /// <summary>
        /// Additional tags for the redshift subnets network ACL
        /// </summary>
        public IDictionary<string, string> RedshiftAclTags { get; set; } = new Dictionary<string, string>();

        /// <summary>
        /// Redshift subnets inbound network ACL rules
        /// </summary>
        public IList<NetworkAclIngress> RedshiftInboundAclRules { get; set; } = new List<NetworkAclIngress>
        {
            new NetworkAclIngress
            {
                RuleNo = 100,
        ...
        /// </summary>
        public IList<NetworkAclEgress> RedshiftOutboundAclRules { get; set; } = new List<NetworkAclEgress>
        {
            new NetworkAclEgress
            {
                RuleNo = 100,
